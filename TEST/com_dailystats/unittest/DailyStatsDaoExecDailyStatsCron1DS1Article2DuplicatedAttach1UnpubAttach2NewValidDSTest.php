 ...
 *
 */
class DailyStatsDaoExecDailyStatsCron1DS1Article2DuplicatedAttach1UnpubAttach2NewValidDSTest extends DailyStatsCronTestBase {
	...
	public function testExecDailyStatsCron2NewAttach1UnpubAttach() { 
		...
		$this->assertEquals(5,$count,'5 daily_stats records expected, 3 for the past and 2 for today for article 1 which has now 3 attachments, one of hwich is unpublished');
	...
	protected function getDataSet() {
		return $this->createXMLDataSet ( dirname ( __FILE__ ) . '\..\data\dailyStatsCron_1_DS_1_article_test_2_dupl_attach_1_unpub_attach_1_new_valid_DS_data.xml' );
	}
}
